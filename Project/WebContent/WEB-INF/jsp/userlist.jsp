	        ...
	        <div class="container">
	          ...
	          <div class="collapse navbar-collapse" id="navbarText">
	            <ul class="navbar-nav">
	              ...
	              <li class="nav-item active">
	                <a class="nav-link" href="userCreate.html">新規登録</a>
	              </li>
	              <li class="nav-item">
	            ...
	            <div class="panel-body">
	              <form method="post" action="#" class="form-horizontal">
	                <div class="form-group">
	                  <font size="5">
	                    <label for="code" class="control-label col-sm-2 label-color">ログインID</label>
	                  </font>
	                  <div class="col-sm-6">
	                ...
	                <div class="form-group">
	                  <font size="5">
	                  <label for="name" class="control-label col-sm-2 label-color">ユーザ名</label>
	                  </font>
	                  <div class="col-sm-6">
