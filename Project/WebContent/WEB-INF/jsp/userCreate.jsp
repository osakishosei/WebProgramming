          ...
          <div class="panel-body">
            ...
            <form method="post" action="userCreateservlet" class="form-horizontal">
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" name="user-id" id="user-id" class="form-control" value="${userErr.loginId}"} required/>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group form-margin">
                ...
                <div class="col-sm-6">
                  <input type="text" name="user-name" id="user-name" class="form-control" value="${userErr.name}"} required/>
                </div>
              </div>
              <div class="form-group form-margin">
                ...
                <div class="row">
                  <div class="col-sm-5">
                    <input type="date" name="birth-day" id="birth-day" class="form-control" size="30" value="${userErr.formatBirthDate}" required/>
                  </div>
              </div>
              </div>
